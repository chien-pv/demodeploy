...
function HomeComponent_h3_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h3");
    \u0275\u0275text(1, " Hello\n");
    \u0275\u0275elementEnd();
...
var _HomeComponent = class _HomeComponent {
  constructor(httpService) {
    ...
    this.loading = true;
    this.url = "https://6659803cde346625136ca9af.mockapi.io/projects";
  }
  getAllData() {
    this.loading = true;
...
_HomeComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["app-home"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 4, vars: 2, consts: [["class", "loader", 4, "ngIf"], [4, "ngFor", "ngForOf"], [1, "loader"]], template: function HomeComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, "home works!");
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, HomeComponent_span_2_Template, 1, 0, "span", 0)(3, HomeComponent_h3_3_Template, 2, 0, "h3", 1);
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
